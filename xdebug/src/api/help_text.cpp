...
const char* fallback_help_text() {
    return
        ...
        "  verify.conditions, apb.query, apb.statistics, axi.query,\n"
        "  axi.statistics, axi.analysis, axi.export,\n"
        "  trace.active_driver.\n\n"
        ...
        "  0 disables proactive soft LRU). XDEBUG_ANALYSIS_CACHE_HARD_MAX_BYTES is\n"
        "  the hard limit (default 2147483648; positive and >= soft). Both are\n"
        "  parsed strictly once at engine startup; invalid values fail startup\n"
