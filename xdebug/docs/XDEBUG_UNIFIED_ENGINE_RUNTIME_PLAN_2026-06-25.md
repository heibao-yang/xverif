...
- `trace.*`、`source.*`、`expr.normalize`、`procedural.assignment`、`sequential.update`、`fsm.explain`、`counter.explain`、`port.trace`、`instance.map`、`interface.resolve` 必须全部只通过 engine handler registry 可达。
