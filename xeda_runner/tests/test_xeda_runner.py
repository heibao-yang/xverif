...
# Add parent dir to path to import xeda_runner
sys.path.insert(0, os.path.join(os.path.dirname(__file__), ".."))
from xeda_runner import (build_argv, generate_init_script, load_env0,
...
class TestGenerateInitScript(unittest.TestCase):
    def _cfg(self, shell="bash", **kw):
        return {
            ...
            "checks": ["make"],
            "env_snapshot": ".xeda_runner/env/env.env0",
            **kw,
        }
