...
| `data.drivers[]` | array | `trace.driver` compact 结果 |
| `data.loads[]` | array | `trace.load` compact 结果 |
...
| --- | --- | --- |
| `trace.driver/load` | summary + compact drivers/loads | assignment、dependency_edges、source、AST、候选全集 |
