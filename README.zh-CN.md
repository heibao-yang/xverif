...
> [!IMPORTANT]
> **开源范围与 Synopsys proprietary dependencies**
>
> 本仓库以 MIT License 发布的范围仅包括仓库中由本项目独立开发的 source code 和 documentation。仓库不包含、也不授权 Synopsys Verdi NPI、FSDB Reader、coverage runtime、headers、libraries 或 documentation。
>
