...
XSVA-W004: large delay range (> 32 or user configured)
XSVA-W005: unbounded delay ($)
XSVA-W006: advanced construct (first_match, throughout, intersect, within)
...
from xsva.ir.timeline import ObligationKind, TimelineIR
